...
"""
 Author:      fyso@163.com
 DateTime:    2017-08-30 14:15:00
 Description: 类和实例、初始化函数、数据封装
"""
__author__ = 'FengYang'
...
bart = Student()
print bart
# <__main__.Student object at 0x00000000029CF390>
print Student
...
print '---------------3  数据封装 data encapsulation ------------------'
